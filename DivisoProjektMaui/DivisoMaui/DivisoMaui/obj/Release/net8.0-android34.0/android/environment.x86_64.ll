...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670927, ; uint32_t jnienv_initialize_method_token (0x6001dcf)
	i32 100670926, ; uint32_t jnienv_registerjninatives_method_token (0x6001dce)
...
@dso_cache = dso_local local_unnamed_addr global [534 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 108438304746928758, ; hash 0x18140104a7c7a76, from name: DivisoMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1414662461048993924, ; hash 0x13a1e4035be7b884, from name: libaot-DivisoMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	...
	%struct.DSOCacheEntry {
		i64 6200213165455761835, ; hash 0x560b95061ab0e1ab, from name: libaot-DivisoMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	...
	%struct.DSOCacheEntry {
		i64 9463090520890881225, ; hash 0x8353a6b0ef1134c9, from name: aot-DivisoMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 269
	...
	%struct.DSOCacheEntry {
		i64 9619070110781930275, ; hash 0x857dcd4d3ebbfb23, from name: aot-DivisoMaui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 15354082640057897594, ; hash 0xd514a8cfcca4927a, from name: DivisoMaui.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DivisoMaui.dll.so
		ptr null; void* handle (0x0)
	}, ; 444
...
@.env.3 = private unnamed_addr constant [37 x i8] c"4c8ab8cd-fd39-45db-b53e-fdca7dd96c23\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.divisomaui\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-DivisoMaui.dll.so\00", align 16
